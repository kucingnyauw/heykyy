...
import { AppAutoComplete } from "./Input";
import { FilledButton } from "./Button";
import { AppFlexLayout } from "./Layout";
import { IconButton } from "./Button";

/**
 * A reusable, memoized custom Table component with built-in features such as
...
export const AppTable = memo(
  ({
    ...
    const renderedSkeletons = useMemo(
      () =>
        Array.from({ length: rowsSkeletonCount }).map((_, idx) => (
      ...
      [rowsSkeletonCount, finalHeaders, theme]
    );
