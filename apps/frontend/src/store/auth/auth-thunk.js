 ...
 * @returns {Promise<{message: string}>} A success message upon successfully sending the email.
 */
 ...
 *
 * @returns {Promise<{message: string}>} A success message upon successful logout.
 */
