...
/**
 * Generates the Material-UI (MUI) theme configuration for the CMS.
 * * @param {"light" | "dark"} [mode="dark"] - The color mode for the theme. Defaults to "dark".
 * @returns {import("@mui/material").Theme} The customized MUI theme object.
 */
export const getTheme = (mode = "dark") => {
  const P = mode === "dark" ? DarkPalette.frontend : LightPalette.frontend;
    ...
    components: {
      MuiCssBaseline: {
        styleOverrides: {
          ...
          ".MuiPaper-root, .MuiCard-root, .MuiDrawer-paper, .MuiDialog-paper": {
            transition: `
              background-color 260ms cubic-bezier(0.4,0,0.2,1),
          ...
          "input:-webkit-autofill, .MuiOutlinedInput-input:-webkit-autofill": {
            WebkitBoxShadow: `0 0 0 1000px ${muted} inset`,
