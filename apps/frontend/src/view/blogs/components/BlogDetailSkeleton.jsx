...
/**
 * Skeleton loader component for the Blog Details page.
 * Mimics the exact layout structure, spacing, and hierarchy of the main BlogsDetails component.
 */
const BlogsDetailSkeleton = memo(() => {
